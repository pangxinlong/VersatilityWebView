...
public class MainActivity extends AppCompatActivity {
    ...
    VersatilityWebChromeClient versatilityWebChromeClient;
...
//        mWebView.loadUrl("http://192.168.3.119:18080/start");//测试文件上传(注，此地址是本人服务器地址)
    ...
    private void setClient() {
        //设置WebChromeClient
        versatilityWebChromeClient = new VersatilityWebChromeClient(this);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        versatilityWebChromeClient.onRequestPermissionsResult(requestCode, permissions, grantResults);
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
        versatilityWebChromeClient.onActivityResult(requestCode, resultCode, data);
    }
}
